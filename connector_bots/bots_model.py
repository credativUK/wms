...
class BotsBackend(orm.Model):
    ...
    _columns = {
        ...
        'feat_picking_out_cancel': fields.selection(
            [('reject', 'Do not allow cancellations'),
             ('ignore', 'Do not export cancellations'),
             ('export', 'Export cancellations')], required=True,
            string='Delivery Order Cancellation Handling',
            help='How to handle delivery order cancellations for this warehouse'),
        'feat_picking_in_cancel': fields.selection(
            [('reject', 'Do not allow cancellations'),
             ('ignore', 'Do not export cancellations'),
             ('export', 'Export cancellations')], required=True,
            string='Shipment Cancellation Handling',
            help='How to handle shipment cancellations for this warehouse'),
    ...
    _defaults = {
        ...
        'feat_picking_out_cancel': 'reject',
        'feat_picking_in_cancel': 'reject',
