    ...
    for BODY in data['WOC']:
        ...
        for ORD in BODY.get('WOC50R', []):
            ...
            for PART in ORD.get('WOC70R', []):
                ...
                PART_ADD_CITY = PART_ADD.get('Place_name')
                ...
                partout.put({'BOTSID':'partner', 'address1': PART_ADD_LINE1})
                partout.put({'BOTSID':'partner', 'address2': PART_ADD_LINE2})
                partout.put({'BOTSID':'partner', 'address3': PART_ADD_LINE3})
                partout.put({'BOTSID':'partner', 'city': PART_ADD_CITY})
                partout.put({'BOTSID':'partner', 'country': PART_ADD_COUNTRY})
                partout.put({'BOTSID':'partner', 'phone': PART_ADD_PHONE})
                partout.put({'BOTSID':'partner', 'fax': PART_ADD_FAX})
